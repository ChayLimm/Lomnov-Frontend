      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Form(
          ...
          child: Column(
            ...
            children: [
              TextFormField(controller: nameCtrl, decoration: const InputDecoration(labelText: 'Room Type Name'), validator: (v) => (v==null||v.trim().isEmpty)?'Required':null),
        ...
        actions: [
          ...
          FilledButton(onPressed: () async {
            ...
            await state.add(nameCtrl.text.trim(), descCtrl.text.trim().isEmpty?null:descCtrl.text.trim());
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            if (state.error != null) Padding(padding: const EdgeInsets.all(8.0), child: Text(state.error!, style: const TextStyle(color: Colors.red))),
            Expanded(
                    ...
                    child: ListTile(
                      ...
                      trailing: Row(mainAxisSize: MainAxisSize.min, children: [
                        IconButton(icon: const Icon(Icons.edit_outlined), onPressed: () async {
                          final nameCtrl = TextEditingController(text: item.roomTypeName);
                          ...
                          await showDialog(context: context, builder: (ctx) => AlertDialog(
                            ...
                            actions: [
                              ...
                              FilledButton(onPressed: () async {
                                if (!formKey.currentState!.validate()) return;
                                final updated = item.copyWith(roomTypeName: nameCtrl.text.trim(), description: descCtrl.text.trim().isEmpty?null:descCtrl.text.trim());
